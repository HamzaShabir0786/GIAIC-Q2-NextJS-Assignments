    ...
    <>
      <main className="home-main h-[90vh] w-[100%] bg-gradient-to-bottom mt-[2px] px-8 grid gap-[10px] relative ">
        <div className="grid-1 pt-[10rem] px-4">
          ...
          <h1 className="text-[2rem] mt-[0.5rem] text-[#8a70f3] font-[600]">
            Welcome to my portfolio
          </h1>
          <p className="[40px] mt-4 text-[1.1rem] tracking-[1px] leading-[40px]">
        ...
        {/* grid 1 end here */}
        <div className="grid-2 px-4 flex justify-center items-center">
          <div
            className="img-div w-[35rem] h-[35rem] bg-[rebeccapurple] border-[4px] border-[#cdc1ff] 
           shadow-[0px_0px_10px_3px_rgb(155,116,239)] rounded-full"
          >
            <Image
