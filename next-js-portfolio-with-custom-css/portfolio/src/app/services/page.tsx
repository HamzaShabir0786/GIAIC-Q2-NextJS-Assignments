        ...
        <div data-aos="zoom-in">
          <div className="services-grid">
            ...
            <div className="grid-items item-3">
              ...
              <br />
              <p>
                I am a passionate SEO Developer.You can hire me for web's SEO
                .If you want to unique, and highly well rank SEO for all browser
                so contact me.
              </p>
              <button>
                <Link href="/contact" target="_blank">
            ...
            <div className="grid-items item-6">
              ...
              <br />
              <p>
                I am a passionate Web-Developer as well web hoster.You can hire
                me as a front-end webdeveloper as well web hoster.If you want to
